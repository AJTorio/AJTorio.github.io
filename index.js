...
const countLike1 = document.getElementById("countDislike1")
const btnDislike2 = document.getElementById("btnDislike2")
const countLike2 = document.getElementById("countDislike2")
function clickLike1(){
...
function clickDislike1(){
   let totalDislike2 = parseInt(countDislike1.value) + 1
